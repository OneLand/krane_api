...
public class GlobalExceptionHander {
    ...
    @ResponseBody
    public ErrorHeader handleError(HttpServletRequest req, HttpServletResponse res, AuthenticationException exception) {
        ErrorHeader errorHeader = new ErrorHeader(exception.getErrorCode().getCode(), exception.getMessage());
        errorLog(req, exception);
        res.setStatus(exception.getErrorCode().getCode());
